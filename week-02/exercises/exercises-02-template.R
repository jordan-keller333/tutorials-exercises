...
water_temp_c
	...
	print(water_temp_c) & print(water_temp_f)
...
over_35 <- (survey_data[survey_data$length_cm > 35, ])
over_35
	
	# 5. Display only the observations where a fish was caught.
	
	caught_true <- (survey_data[survey_data$caught, ])
	caught_true
	
	# 6. What is the mean length of the fish that were caught?
	
	mean(caught_true$length_cm)
...
large_and_caught
	...
	#
	# Response:
# I know how to do data frames better and also the challenge was helpful for similar exercises
